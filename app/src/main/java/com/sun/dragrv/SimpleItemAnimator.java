...
import com.sun.dragrv.DragRecyclerView.Adapter;
...
abstract public class
        SimpleItemAnimator extends DragRecyclerView.ItemAnimator {
    ...
    @Override
    public boolean canReuseUpdatedViewHolder(DragRecyclerView.ViewHolder viewHolder) {
    ...
    public boolean animateDisappearance(@NonNull ViewHolder viewHolder,
        ...
        if (!viewHolder.isRemoved() && (oldLeft != newLeft || oldTop != newTop)) {
            ...
            if (DEBUG) {
                sLog.d(TAG, "DISAPPEARING: " + viewHolder + " with view " + disappearingItemView);
            }
            return animateMove(viewHolder, oldLeft, oldTop, newLeft, newTop);
        } else {
            if (DEBUG) {
                sLog.d(TAG, "REMOVED: " + viewHolder + " with view " + disappearingItemView);
            }
    ...
    public boolean animateAppearance(@NonNull ViewHolder viewHolder,
        ...
        if (preLayoutInfo != null && (preLayoutInfo.left != postLayoutInfo.left
            ...
            if (DEBUG) {
                sLog.d(TAG, "APPEARING: " + viewHolder + " with view " + viewHolder);
            }
            return animateMove(viewHolder, preLayoutInfo.left, preLayoutInfo.top,
                    postLayoutInfo.left, postLayoutInfo.top);
        } else {
            if (DEBUG) {
                sLog.d(TAG, "ADDED: " + viewHolder + " with view " + viewHolder);
            }
    ...
    public boolean animatePersistence(@NonNull ViewHolder viewHolder,
        ...
        if (preInfo.left != postInfo.left || preInfo.top != postInfo.top) {
            if (DEBUG) {
                sLog.d(TAG, "PERSISTENT: " + viewHolder +
    ...
    public boolean animateChange(@NonNull ViewHolder oldHolder, @NonNull ViewHolder newHolder,
            @NonNull ItemHolderInfo preInfo, @NonNull ItemHolderInfo postInfo) {
        if (DEBUG) {
            sLog.d(TAG, "CHANGED: " + oldHolder + " with view " + oldHolder.itemView);
        }
