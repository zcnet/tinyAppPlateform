 ...
 */
public class DragRecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    private final ViewInfoStore.ProcessCallback mViewInfoProcessCallback =
        ...
        @Override
        public void processDisappeared(ViewHolder viewHolder, ItemAnimator.ItemHolderInfo info,
                ItemAnimator.ItemHolderInfo postInfo) {
    ...
    public DragRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            int defStyleRes = 0;
            TypedArray a = context.obtainStyledAttributes(attrs, DragR.styleable.RecyclerView,
                    defStyle, defStyleRes);
            String layoutManagerName = a.getString(DragR.styleable.RecyclerView_layoutManager);
            a.recycle();
    ...
    private String getFullClassName(Context context, String className) {
        ...
        return DragRecyclerView.class.getPackage().getName() + '.' + className;
    }
    ...
    private void initChildrenHelper() {
        mChildHelper = new ChildHelper(new ChildHelper.Callback() {
            ...
            public int getChildCount() {
                return DragRecyclerView.this.getChildCount();
            }

            @Override
            public void addView(View child, int index) {
                DragRecyclerView.this.addView(child, index);
                dispatchChildAttached(child);
            }

            @Override
            public int indexOfChild(View view) {
                return DragRecyclerView.this.indexOfChild(view);
            }

            @Override
            public void removeViewAt(int index) {
                final View child = DragRecyclerView.this.getChildAt(index);
                if (child != null) {
                    dispatchChildDetached(child);
                }
                DragRecyclerView.this.removeViewAt(index);
            }

            @Override
            public View getChildAt(int offset) {
                return DragRecyclerView.this.getChildAt(offset);
            }
            ...
            public void removeAllViews() {
                ...
                DragRecyclerView.this.removeAllViews();
            }
            ...
            public void attachViewToParent(View child, int index,
                ...
                if (vh != null) {
                    ...
                    if (DEBUG) {
                        sLog.d(TAG, "reAttach " + vh);
                    }
                    vh.clearTmpDetachFlag();
                }
                DragRecyclerView.this.attachViewToParent(child, index, layoutParams);
            }
            ...
            public void detachViewFromParent(int offset) {
                ...
                if (view != null) {
                    ...
                    if (vh != null) {
                        ...
                        if (DEBUG) {
                            sLog.d(TAG, "tmpDetach " + vh);
                        }
                        vh.addFlags(ViewHolder.FLAG_TMP_DETACHED);
                    }
                }
                DragRecyclerView.this.detachViewFromParent(offset);
            }
        ...
        mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() {
            ...
            public ViewHolder findViewHolder(int position) {
                ...
                if (mChildHelper.isHidden(vh.itemView)) {
                    if (DEBUG) {
                        sLog.d(TAG, "assuming view holder cannot be find because it is hidden");
                    }
                    return null;
                }
                return vh;
            ...
            void dispatchUpdate(AdapterHelper.UpdateOp op) {
                switch (op.cmd) {
                    case AdapterHelper.UpdateOp.ADD:
                        mLayout.onItemsAdded(DragRecyclerView.this, op.positionStart, op.itemCount);
                        break;
                    case AdapterHelper.UpdateOp.REMOVE:
                        mLayout.onItemsRemoved(DragRecyclerView.this, op.positionStart, op.itemCount);
                        break;
                    case AdapterHelper.UpdateOp.UPDATE:
                        mLayout.onItemsUpdated(DragRecyclerView.this, op.positionStart, op.itemCount,
                                op.payload);
                        break;
                    case AdapterHelper.UpdateOp.MOVE:
                        mLayout.onItemsMoved(DragRecyclerView.this, op.positionStart, op.itemCount, 1);
                        break;
                }
            }
    ...
    public void setScrollingTouchSlop(int slopConstant) {
        ...
        switch (slopConstant) {
            default:
                sLog.w(TAG, "setScrollingTouchSlop(): bad argument constant "
    ...
    public void setLayoutManager(LayoutManager layout) {
        ...
        mLayout = layout;
        if (layout != null) {
            if (layout.mDragRecyclerView != null) {
                throw new IllegalArgumentException("LayoutManager " + layout +
                        " is already attached to a RecyclerView: " + layout.mDragRecyclerView);
            }
     ...
     * @see #addAnimatingView(DragRecyclerView.ViewHolder)
    ...
    private boolean removeAnimatingView(View view) {
        ...
        if (removed) {
            ...
            if (DEBUG) {
                sLog.d(TAG, "after removing animated view: " + view + ", " + this);
            }
        }
    ...
    private void setScrollState(int state) {
        ...
        if (DEBUG) {
            sLog.d(TAG, "setting scroll state to " + state + " from " + mScrollState,
                    new Exception());
        }
        mScrollState = state;
     ...
     * {@link DragRecyclerView.LayoutManager#scrollToPosition(int)}
     * @param position Scroll to this adapter position
     * @see DragRecyclerView.LayoutManager#scrollToPosition(int)
     */
    public void scrollToPosition(int position) {
        ...
        stopScroll();
        if (mLayout == null) {
            sLog.e(TAG, "Cannot scroll to position a LayoutManager set. " +
     ...
     * {@link LayoutManager#smoothScrollToPosition(DragRecyclerView, State, int)} and create a
     * {@link SmoothScroller}.
     * <p>
     * {@link LayoutManager} is responsible for creating the actual scroll action. If you want to
     * provide a custom smooth scroll logic, override
     * {@link LayoutManager#smoothScrollToPosition(DragRecyclerView, State, int)} in your
     * LayoutManager.
     *
     * @param position The adapter position to scroll to
     * @see LayoutManager#smoothScrollToPosition(DragRecyclerView, State, int)
     */
    public void smoothScrollToPosition(int position) {
        ...
        if (mLayout == null) {
            sLog.e(TAG, "Cannot smooth scroll without a LayoutManager set. " +
                    "Call setLayoutManager with a non-null argument.");
            return;
        }
    ...
    public void scrollTo(int x, int y) {
        sLog.w(TAG, "RecyclerView does not support scrolling to an absolute position. "
    ...
    public void scrollBy(int x, int y) {
        if (mLayout == null) {
            sLog.e(TAG, "Cannot scroll without a LayoutManager set. " +
                    "Call setLayoutManager with a non-null argument.");
            return;
        }
        if (mLayoutFrozen) {
     ...
     * {@link DragRecyclerView.LayoutManager#computeHorizontalScrollOffset(DragRecyclerView.State)} in your
     * LayoutManager. </p>
     *
     * @return The horizontal offset of the scrollbar's thumb
     * @see DragRecyclerView.LayoutManager#computeHorizontalScrollOffset
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link DragRecyclerView.LayoutManager#computeHorizontalScrollExtent(DragRecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The horizontal extent of the scrollbar's thumb
     * @see DragRecyclerView.LayoutManager#computeHorizontalScrollExtent(DragRecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link DragRecyclerView.LayoutManager#computeHorizontalScrollRange(DragRecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The total horizontal range represented by the vertical scrollbar
     * @see DragRecyclerView.LayoutManager#computeHorizontalScrollRange(DragRecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link DragRecyclerView.LayoutManager#computeVerticalScrollOffset(DragRecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The vertical offset of the scrollbar's thumb
     * @see DragRecyclerView.LayoutManager#computeVerticalScrollOffset
     * (RecyclerView.Adapter)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link DragRecyclerView.LayoutManager#computeVerticalScrollExtent(DragRecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The vertical extent of the scrollbar's thumb
     * @see DragRecyclerView.LayoutManager#computeVerticalScrollExtent(DragRecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link DragRecyclerView.LayoutManager#computeVerticalScrollRange(DragRecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The total vertical range represented by the vertical scrollbar
     * @see DragRecyclerView.LayoutManager#computeVerticalScrollRange(DragRecyclerView.State)
     */
    @Override
    ...
    public boolean fling(int velocityX, int velocityY) {
        if (mLayout == null) {
            sLog.e(TAG, "Cannot fling without a LayoutManager set. " +
                    "Call setLayoutManager with a non-null argument.");
            return false;
        }
        if (mLayoutFrozen) {
     ...
     * returns true from
     * {@link OnItemTouchListener#onInterceptTouchEvent(DragRecyclerView, MotionEvent)} its
     * {@link OnItemTouchListener#onTouchEvent(DragRecyclerView, MotionEvent)} method will be called
    ...
    public boolean onInterceptTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (index < 0) {
                    sLog.e(TAG, "Error processing scroll; pointer index for id " +
...
//
    void dispatchLayout() {
        if (mAdapter == null) {
            sLog.e(TAG, "No adapter attached; skipping layout");
            return;
        }
        if (mLayout == null) {
            sLog.e(TAG, "No layout manager attached; skipping layout");
            return;
        }
    ...
    void offsetPositionRecordsForMove(int from, int to) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (DEBUG) {
                sLog.d(TAG, "offsetPositionRecordsForMove attached child " + i + " holder " +
                        holder);
            }
    ...
    void offsetPositionRecordsForInsert(int positionStart, int itemCount) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (holder != null && !holder.shouldIgnore() && holder.mPosition >= positionStart) {
                if (DEBUG) {
                    sLog.d(TAG, "offsetPositionRecordsForInsert attached child " + i + " holder " +
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (holder != null && !holder.shouldIgnore()) {
                if (holder.mPosition >= positionEnd) {
                    if (DEBUG) {
                        sLog.d(TAG, "offsetPositionRecordsForRemove attached child " + i +
    ...
    private class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (ViewCompat.getOverScrollMode(DragRecyclerView.this) !=
    ...
    private class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        void triggerUpdateProcessor() {
            if (mPostUpdatesOnAnimation && mHasFixedSize && mIsAttached) {
                ViewCompat.postOnAnimation(DragRecyclerView.this, mUpdateChildViewsRunnable);
            } else {
     ...
     * and use {@link DragRecyclerView#setRecycledViewPool(RecycledViewPool)}.
     * <p>
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(View view, int position) {
            ...
            holder.mOwnerDragRecyclerView = DragRecyclerView.this;
        ...
        View getViewForPosition(int position, boolean dryRun) {
            ...
            if (holder == null) {
                ...
                if (holder == null) { // fallback to recycler
                    ...
                    if (DEBUG) {
                        sLog.d(TAG, "getViewForPosition(" + position + ") fetching from shared "
                                + "pool");
                    }
                ...
                if (holder == null) {
                    holder = mAdapter.createViewHolder(DragRecyclerView.this, type);
                    if (DEBUG) {
                        sLog.d(TAG, "getViewForPosition created new ViewHolder");
                    }
                }
            }
        ...
        void recycleCachedViewAt(int cachedViewIndex) {
            if (DEBUG) {
                sLog.d(TAG, "Recycling cached view at index " + cachedViewIndex);
            }
            ViewHolder viewHolder = mCachedViews.get(cachedViewIndex);
            if (DEBUG) {
                sLog.d(TAG, "CachedViewHolder to be recycled: " + viewHolder);
            }
        ...
        void recycleViewHolderInternal(ViewHolder holder) {
            ...
            if (forceRecycle || holder.isRecyclable()) {
                ...
                sLog.d(TAG, "trying to recycle a non-recycleable holder. Hopefully, it will "
            ...
            if (!cached && !recycled && transientStatePreventsRecycling) {
                holder.mOwnerDragRecyclerView = null;
            }
        }
        ...
        ViewHolder getScrapViewForPosition(int position, int type, boolean dryRun) {
            ...
            for (int i = 0; i < scrapCount; i++) {
                ...
                if (!holder.wasReturnedFromScrap() && holder.getLayoutPosition() == position
                    ...
                    if (type != INVALID_TYPE && holder.getItemViewType() != type) {
                        sLog.e(TAG, "Scrap view for position " + position + " isn't dirty but has" +
            ...
            if (!dryRun) {
                ...
                if (view != null) {
                    ...
                    if (layoutIndex == DragRecyclerView.NO_POSITION) {
            ...
            for (int i = 0; i < cacheSize; i++) {
                ...
                if (!holder.isInvalid() && holder.getLayoutPosition() == position) {
                    ...
                    if (DEBUG) {
                        sLog.d(TAG, "getScrapViewForPosition(" + position + ", " + type +
        ...
        void dispatchViewRecycled(ViewHolder holder) {
            ...
            if (DEBUG) sLog.d(TAG, "dispatchViewRecycled: " + holder);
        }
        ...
        void offsetPositionRecordsForMove(int from, int to) {
            ...
            for (int i = 0; i < cachedCount; i++) {
                ...
                if (DEBUG) {
                    sLog.d(TAG, "offsetPositionRecordsForMove cached child " + i + " holder " +
                            holder);
                }
            }
        }
        ...
        void offsetPositionRecordsForInsert(int insertedAt, int count) {
            ...
            for (int i = 0; i < cachedCount; i++) {
                ...
                if (holder != null && holder.getLayoutPosition() >= insertedAt) {
                    if (DEBUG) {
                        sLog.d(TAG, "offsetPositionRecordsForInsert cached " + i + " holder " +
            ...
            for (int i = cachedCount - 1; i >= 0; i--) {
                ...
                if (holder != null) {
                    if (holder.getLayoutPosition() >= removedEnd) {
                        if (DEBUG) {
                            sLog.d(TAG, "offsetPositionRecordsForRemove cached " + i +
                                    " holder " + holder + " now at position " +
     ...
     * within a {@link DragRecyclerView}.</p>
     */
    public static abstract class Adapter<VH extends ViewHolder> {
         ...
         * needs to be attached to its parent {@link DragRecyclerView}. This can be because it has
         ...
         * <p>
         * Note that when all animations are created by {@link DragRecyclerView.ItemAnimator}, you
         ...
         * {@link #onViewDetachedFromWindow(DragRecyclerView.ViewHolder) onViewDetachedFromWindow}
         ...
         * {@link DragRecyclerView.AdapterDataObserver#onChanged()
         * "something changed"} event if more specific data is not available.</p>
         *
         * <p>Components registering observers with an adapter are responsible for
         * {@link #unregisterAdapterDataObserver(DragRecyclerView.AdapterDataObserver)
         * unregistering} those observers when finished.</p>
         *
         * @param observer Observer to register
         *
         * @see #unregisterAdapterDataObserver(DragRecyclerView.AdapterDataObserver)
         */
         ...
         *
         * @see #registerAdapterDataObserver(DragRecyclerView.AdapterDataObserver)
         */
         ...
         *
         * @param dragRecyclerView The RecyclerView instance which started observing this adapter.
         * @see #onDetachedFromRecyclerView(DragRecyclerView)
         */
        public void onAttachedToRecyclerView(DragRecyclerView dragRecyclerView) {
        }

        /**
         * Called by RecyclerView when it stops observing this Adapter.
         *
         * @param dragRecyclerView The RecyclerView instance which stopped observing this adapter.
         * @see #onAttachedToRecyclerView(DragRecyclerView)
         */
        public void onDetachedFromRecyclerView(DragRecyclerView dragRecyclerView) {
        }
...
//     * be then obtained from {@link #getProperties(Context, AttributeSet, int, int)}. In case
    ...
    public static abstract class LayoutManager {
        ...
        void setRecyclerView(DragRecyclerView dragRecyclerView) {
            if (dragRecyclerView == null) {
                mDragRecyclerView = null;
                mChildHelper = null;
            } else {
                mDragRecyclerView = dragRecyclerView;
                mChildHelper = dragRecyclerView.mChildHelper;
            }
         ...
         */
        public void requestLayout() {
            if(mDragRecyclerView != null) {
                mDragRecyclerView.requestLayout();
            }
        }
        ...
        public void assertInLayoutOrScroll(String message) {
            if (mDragRecyclerView != null) {
                mDragRecyclerView.assertInLayoutOrScroll(message);
            }
        }
        ...
        public void assertNotInLayoutOrScroll(String message) {
            if (mDragRecyclerView != null) {
                mDragRecyclerView.assertNotInLayoutOrScroll(message);
            }
        }
         ...
         * {@link DragRecyclerView#setItemAnimator(ItemAnimator) ItemAnimator} set on the
        ...
        void dispatchAttachedToWindow(DragRecyclerView view) {
            mIsAttachedToWindow = true;
            onAttachedToWindow(view);
        }

        void dispatchDetachedFromWindow(DragRecyclerView view, Recycler recycler) {
        ...
        public void postOnAnimation(Runnable action) {
            if (mDragRecyclerView != null) {
                ViewCompat.postOnAnimation(mDragRecyclerView, action);
            }
        }
        ...
        public boolean removeCallbacks(Runnable action) {
            if (mDragRecyclerView != null) {
                return mDragRecyclerView.removeCallbacks(action);
            }
            return false;
        }
        /**
         ...
         */
        @CallSuper
        public void onAttachedToWindow(DragRecyclerView view) {
        }

        /**
         * @deprecated
         * override {@link #onDetachedFromWindow(DragRecyclerView, Recycler)}
         */
        @Deprecated
        public void onDetachedFromWindow(DragRecyclerView view) {
         ...
         */
        @CallSuper
        public void onDetachedFromWindow(DragRecyclerView view, Recycler recycler) {
        ...
        public boolean getClipToPadding() {
            return mDragRecyclerView != null && mDragRecyclerView.mClipToPadding;
        }
        ...
        public void onLayoutChildren(Recycler recycler, State state) {
            sLog.e(TAG, "You must override onLayoutChildren(Recycler recycler, State state) ");
        }
         ...
         * {@link DragRecyclerView.LayoutParams} for this purpose.</p>
         *
        ...
        public void scrollToPosition(int position) {
            if (DEBUG) {
                sLog.e(TAG, "You MUST implement scrollToPosition. It will soon become abstract");
            }
        }
         ...
         * </p>
         * @param dragRecyclerView The RecyclerView to which this layout manager is attached
         * @param state    Current State of RecyclerView
         * @param position Scroll to this adapter position.
         */
        public void smoothScrollToPosition(DragRecyclerView dragRecyclerView, State state,
                                           int position) {
            sLog.e(TAG, "You must override smoothScrollToPosition to support smooth scrolling");
        }
        ...
        public void startSmoothScroll(SmoothScroller smoothScroller) {
            ...
            mSmoothScroller.start(mDragRecyclerView, this);
        }
        ...
        public int getLayoutDirection() {
            return ViewCompat.getLayoutDirection(mDragRecyclerView);
        }
         ...
         * @see DragRecyclerView.ItemAnimator#endAnimations()
         */
        public void endAnimation(View view) {
            if (mDragRecyclerView.mItemAnimator != null) {
                mDragRecyclerView.mItemAnimator.endAnimation(getChildViewHolderInt(view));
            }
        }
        ...
        private void addViewInt(View child, int index, boolean disappearing) {
            ...
            if (disappearing || holder.isRemoved()) {
                ...
                mDragRecyclerView.mViewInfoStore.addToDisappearedInLayout(holder);
            } else {
                ...
                mDragRecyclerView.mViewInfoStore.removeFromDisappearedInLayout(holder);
            }
            final LayoutParams lp = (LayoutParams) child.getLayoutParams();
            if (holder.wasReturnedFromScrap() || holder.isScrap()) {
            ...
            } else if (child.getParent() == mDragRecyclerView) { // it was not a scrap but a valid child
                ...
                if (currentIndex == -1) {
                    throw new IllegalStateException("Added View has RecyclerView as parent but"
                            ...
                            + mDragRecyclerView.indexOfChild(child));
                }
                if (currentIndex != index) {
                    mDragRecyclerView.mLayout.moveView(currentIndex, index);
                }
            } else {
            ...
            if (lp.mPendingInvalidate) {
                if (DEBUG) {
                    sLog.d(TAG, "consuming pending invalidate on child " + lp.mViewHolder);
                }
        ...
        public int getPosition(View view) {
            return ((DragRecyclerView.LayoutParams) view.getLayoutParams()).getViewLayoutPosition();
        }
        ...
        public View findViewByPosition(int position) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (vh.getLayoutPosition() == position && !vh.shouldIgnore() &&
                        (mDragRecyclerView.mState.isPreLayout() || !vh.isRemoved())) {
                    return child;
                }
            }
            return null;
         ...
         * will want to use {@link #detachAndScrapView(android.view.View, DragRecyclerView.Recycler)}
         ...
         * {@link #attachView(android.view.View, int, DragRecyclerView.LayoutParams) reattach}
         ...
         * {@link #detachAndScrapView(android.view.View, DragRecyclerView.Recycler)}  scrapped}.
         *
        ...
        public void attachView(View child, int index, LayoutParams lp) {
            ViewHolder vh = getChildViewHolderInt(child);
            if (vh.isRemoved()) {
                mDragRecyclerView.mViewInfoStore.addToDisappearedInLayout(vh);
            } else {
                mDragRecyclerView.mViewInfoStore.removeFromDisappearedInLayout(vh);
            }
        ...
        public void removeDetachedView(View child) {
            mDragRecyclerView.removeDetachedView(child, false);
        }
         ...
         */
        public int getWidth() {
            return mDragRecyclerView != null ? mDragRecyclerView.getWidth() : 0;
        }
        ...
        public int getHeight() {
            return mDragRecyclerView != null ? mDragRecyclerView.getHeight() : 0;
        }
        ...
        public int getPaddingLeft() {
            return mDragRecyclerView != null ? mDragRecyclerView.getPaddingLeft() : 0;
        }
        ...
        public int getPaddingTop() {
            return mDragRecyclerView != null ? mDragRecyclerView.getPaddingTop() : 0;
        }
        ...
        public int getPaddingRight() {
            return mDragRecyclerView != null ? mDragRecyclerView.getPaddingRight() : 0;
        }
        ...
        public int getPaddingBottom() {
            return mDragRecyclerView != null ? mDragRecyclerView.getPaddingBottom() : 0;
        }
        ...
        public int getPaddingStart() {
            return mDragRecyclerView != null ? ViewCompat.getPaddingStart(mDragRecyclerView) : 0;
        }
        ...
        public int getPaddingEnd() {
            return mDragRecyclerView != null ? ViewCompat.getPaddingEnd(mDragRecyclerView) : 0;
        }
        ...
        public boolean isFocused() {
            return mDragRecyclerView != null && mDragRecyclerView.isFocused();
        }
        ...
        public boolean hasFocus() {
            return mDragRecyclerView != null && mDragRecyclerView.hasFocus();
        }
        ...
        public View getFocusedChild() {
            ...
            final View focused = mDragRecyclerView.getFocusedChild();
        ...
        public int getItemCount() {
            final Adapter a = mDragRecyclerView != null ? mDragRecyclerView.getAdapter() : null;
        ...
        public void offsetChildrenHorizontal(int dx) {
            if (mDragRecyclerView != null) {
                mDragRecyclerView.offsetChildrenHorizontal(dx);
            }
        }
        ...
        public void offsetChildrenVertical(int dy) {
            if (mDragRecyclerView != null) {
                mDragRecyclerView.offsetChildrenVertical(dy);
            }
        }
        ...
        public void ignoreView(View view) {
            if (view.getParent() != mDragRecyclerView || mDragRecyclerView.indexOfChild(view) == -1) {
            ...
            mDragRecyclerView.mViewInfoStore.removeViewHolder(vh);
        }
        ...
        private void scrapOrRecycleView(Recycler recycler, int index, View view) {
            ...
            if (viewHolder.shouldIgnore()) {
                if (DEBUG) {
                    sLog.d(TAG, "ignoring view " + viewHolder);
                }
                return;
            }
            if (viewHolder.isInvalid() && !viewHolder.isRemoved() &&
                    !mDragRecyclerView.mAdapter.hasStableIds()) {
                removeViewAt(index);
        ...
        void removeAndRecycleScrapInt(Recycler recycler) {
            ...
            for (int i = scrapCount - 1; i >= 0; i--) {
                ...
                if (vh.isTmpDetached()) {
                    mDragRecyclerView.removeDetachedView(scrap, false);
                }
                if (mDragRecyclerView.mItemAnimator != null) {
                    mDragRecyclerView.mItemAnimator.endAnimation(vh);
                }
        ...
        public void measureChild(View child, int widthUsed, int heightUsed) {
            ...
            final Rect insets = mDragRecyclerView.getItemDecorInsetsForChild(child);
        ...
        public void calculateItemDecorationsForChild(View child, Rect outRect) {
            ...
            Rect insets = mDragRecyclerView.getItemDecorInsetsForChild(child);
            outRect.set(insets);
        }
         ...
         * then {@link #onFocusSearchFailed(View, int, DragRecyclerView.Recycler, DragRecyclerView.State)}
         ...
         */
        public boolean requestChildRectangleOnScreen(DragRecyclerView parent, View child, Rect rect,
                                                     boolean immediate) {
        ...
        /**
         * @deprecated Use {@link #onRequestChildFocus(DragRecyclerView, State, View, View)}
         */
        @Deprecated
        public boolean onRequestChildFocus(DragRecyclerView parent, View child, View focused) {
         ...
         */
        public boolean onRequestChildFocus(DragRecyclerView parent, State state, View child,
                                           View focused) {
         ...
         *                   {@link #setAdapter(DragRecyclerView.Adapter)} is called with {@code null}.
         */
         ...
         *
         * @param dragRecyclerView The RecyclerView hosting this LayoutManager
         ...
         */
        public boolean onAddFocusables(DragRecyclerView dragRecyclerView, ArrayList<View> views,
         ...
         *
         * @param dragRecyclerView
         */
        public void onItemsChanged(DragRecyclerView dragRecyclerView) {
        }
         ...
         * @param itemCount
         */
        public void onItemsAdded(DragRecyclerView dragRecyclerView, int positionStart, int itemCount) {
        }
         ...
         * @param itemCount
         */
        public void onItemsRemoved(DragRecyclerView dragRecyclerView, int positionStart, int itemCount) {
        }

        /**
         * Called when items have been changed in the adapter.
         * To receive payload,  override {@link #onItemsUpdated(DragRecyclerView, int, int, Object)}
         ...
         * @param itemCount
         */
        public void onItemsUpdated(DragRecyclerView dragRecyclerView, int positionStart, int itemCount) {
        }

        /**
         * Called when items have been changed in the adapter and with optional payload.
         * Default implementation calls {@link #onItemsUpdated(DragRecyclerView, int, int)}.
         *
         * @param dragRecyclerView
         * @param positionStart
         * @param itemCount
        ...
        public void onItemsUpdated(DragRecyclerView dragRecyclerView, int positionStart, int itemCount,
                                   Object payload) {
            onItemsUpdated(dragRecyclerView, positionStart, itemCount);
        }
         ...
         * @param itemCount
         */
        public void onItemsMoved(DragRecyclerView dragRecyclerView, int from, int to, int itemCount) {
         ...
         *
         * <p>Read {@link DragRecyclerView#computeHorizontalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerView
         * @return The horizontal extent of the scrollbar's thumb
         * @see DragRecyclerView#computeHorizontalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link DragRecyclerView#computeHorizontalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The horizontal offset of the scrollbar's thumb
         * @see DragRecyclerView#computeHorizontalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link DragRecyclerView#computeHorizontalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The total horizontal range represented by the vertical scrollbar
         * @see DragRecyclerView#computeHorizontalScrollRange()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link DragRecyclerView#computeVerticalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerView
         * @return The vertical extent of the scrollbar's thumb
         * @see DragRecyclerView#computeVerticalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link DragRecyclerView#computeVerticalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The vertical offset of the scrollbar's thumb
         * @see DragRecyclerView#computeVerticalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link DragRecyclerView#computeVerticalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The total vertical range represented by the vertical scrollbar
         * @see DragRecyclerView#computeVerticalScrollRange()
         */
        ...
        public void onMeasure(Recycler recycler, State state, int widthSpec, int heightSpec) {
            mDragRecyclerView.defaultOnMeasure(widthSpec, heightSpec);
        }
        ...
        public void setMeasuredDimension(int widthSize, int heightSize) {
            mDragRecyclerView.setMeasuredDimension(widthSize, heightSize);
        }
        ...
        public int getMinimumWidth() {
            return ViewCompat.getMinimumWidth(mDragRecyclerView);
        }
        ...
        public int getMinimumHeight() {
            return ViewCompat.getMinimumHeight(mDragRecyclerView);
        }
        /**
        ...
        void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfoCompat info) {
            onInitializeAccessibilityNodeInfo(mDragRecyclerView.mRecycler, mDragRecyclerView.mState, info);
        }
         ...
         * <p>
         * You should override
         * {@link #getRowCountForAccessibility(DragRecyclerView.Recycler, DragRecyclerView.State)},
         * {@link #getColumnCountForAccessibility(DragRecyclerView.Recycler, DragRecyclerView.State)},
         * {@link #isLayoutHierarchical(DragRecyclerView.Recycler, DragRecyclerView.State)} and
         * {@link #getSelectionModeForAccessibility(DragRecyclerView.Recycler, DragRecyclerView.State)} for
         ...
         * @see #getRowCountForAccessibility(DragRecyclerView.Recycler, DragRecyclerView.State)
         * @see #getColumnCountForAccessibility(DragRecyclerView.Recycler, DragRecyclerView.State)
         * @see #isLayoutHierarchical(DragRecyclerView.Recycler, DragRecyclerView.State)
         * @see #getSelectionModeForAccessibility(DragRecyclerView.Recycler, DragRecyclerView.State)
         */
        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state,
                AccessibilityNodeInfoCompat info) {
            if (ViewCompat.canScrollVertically(mDragRecyclerView, -1) ||
                    ViewCompat.canScrollHorizontally(mDragRecyclerView, -1)) {
        ...
        public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
            onInitializeAccessibilityEvent(mDragRecyclerView.mRecycler, mDragRecyclerView.mState, event);
        }
        ...
        public void onInitializeAccessibilityEvent(Recycler recycler, State state,
            ...
            final AccessibilityRecordCompat record = AccessibilityEventCompat
                    .asRecord(event);
            if (mDragRecyclerView == null || record == null) {
                return;
            }
            record.setScrollable(ViewCompat.canScrollVertically(mDragRecyclerView, 1)
                    || ViewCompat.canScrollVertically(mDragRecyclerView, -1)
                    || ViewCompat.canScrollHorizontally(mDragRecyclerView, -1)
                    || ViewCompat.canScrollHorizontally(mDragRecyclerView, 1));

            if (mDragRecyclerView.mAdapter != null) {
                record.setItemCount(mDragRecyclerView.mAdapter.getItemCount());
            }
        }
        ...
        void onInitializeAccessibilityNodeInfoForItem(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (vh != null && !vh.isRemoved() && !mChildHelper.isHidden(vh.itemView)) {
                onInitializeAccessibilityNodeInfoForItem(mDragRecyclerView.mRecycler,
                        mDragRecyclerView.mState, host, info);
            }
        }
        ...
        public int getRowCountForAccessibility(Recycler recycler, State state) {
            if (mDragRecyclerView == null || mDragRecyclerView.mAdapter == null) {
                return 1;
            }
            return canScrollVertically() ? mDragRecyclerView.mAdapter.getItemCount() : 1;
        }
        ...
        public int getColumnCountForAccessibility(Recycler recycler, State state) {
            ...
            return canScrollHorizontally() ? mDragRecyclerView.mAdapter.getItemCount() : 1;
        }
        ...
        boolean performAccessibilityAction(int action, Bundle args) {
            return performAccessibilityAction(mDragRecyclerView.mRecycler, mDragRecyclerView.mState,
                    action, args);
        }
        ...
        public boolean performAccessibilityAction(Recycler recycler, State state, int action,
            ...
            switch (action) {
                case AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD:
                    ...
                    if (ViewCompat.canScrollHorizontally(mDragRecyclerView, -1)) {
            ...
            mDragRecyclerView.scrollBy(hScroll, vScroll);
            return true;
        }

        // called by accessibility delegate
        boolean performAccessibilityActionForItem(View view, int action, Bundle args) {
            return performAccessibilityActionForItem(mDragRecyclerView.mRecycler, mDragRecyclerView.mState,
                    view, action, args);
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs,
            ...
            properties.orientation = a.getInt(DragR.styleable.RecyclerView_android_orientation, VERTICAL);
            properties.spanCount = a.getInt(DragR.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(DragR.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(DragR.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
     ...
     * views (in {@link ItemDecoration#onDraw(Canvas, DragRecyclerView, DragRecyclerView.State) onDraw()}
     * and after the items (in {@link ItemDecoration#onDrawOver(Canvas, DragRecyclerView,
     * DragRecyclerView.State)}.</p>
     */
    public static abstract class ItemDecoration {
         ...
         * @param state The current state of RecyclerView
         */
        public void onDraw(Canvas c, DragRecyclerView parent, State state) {
            onDraw(c, parent);
        }

        /**
         * @deprecated
         * Override {@link #onDraw(Canvas, DragRecyclerView, DragRecyclerView.State)}
         */
        @Deprecated
        public void onDraw(Canvas c, DragRecyclerView parent) {
        }
         ...
         * @param state The current state of RecyclerView.
         */
        public void onDrawOver(Canvas c, DragRecyclerView parent, State state) {
            onDrawOver(c, parent);
        }

        /**
         * @deprecated
         * Override {@link #onDrawOver(Canvas, DragRecyclerView, DragRecyclerView.State)}
         */
        @Deprecated
        public void onDrawOver(Canvas c, DragRecyclerView parent) {
        }


        /**
         * @deprecated
         * Use {@link #getItemOffsets(Rect, View, DragRecyclerView, State)}
         */
        @Deprecated
        public void getItemOffsets(Rect outRect, int itemPosition, DragRecyclerView parent) {
            outRect.set(0, 0, 0, 0);
        }
         ...
         * {@link DragRecyclerView#getChildAdapterPosition(View)} to get the adapter position of the
         * View.
         *
         ...
         * @param state   The current state of RecyclerView.
         */
        public void getItemOffsets(Rect outRect, View view, DragRecyclerView parent, State state) {
    ...
    public static interface OnItemTouchListener {
         ...
         *         the gesture.
         */
        public boolean onInterceptTouchEvent(DragRecyclerView rv, MotionEvent e);
         ...
         *          the RecyclerView's coordinate system.
         */
        public void onTouchEvent(DragRecyclerView rv, MotionEvent e);
    ...
    /**
     * An implementation of {@link DragRecyclerView.OnItemTouchListener} that has empty method bodies and
     ...
     */
    public static class SimpleOnItemTouchListener implements DragRecyclerView.OnItemTouchListener {
        @Override
        public boolean onInterceptTouchEvent(DragRecyclerView rv, MotionEvent e) {
            return false;
        }
     ...
     *
     * @see DragRecyclerView#setOnScrollListener(OnScrollListener) and
    ...
    public abstract static class OnScrollListener {
         ...
         *
         * @param dragRecyclerView The RecyclerView whose scroll state has changed.
         ...
         *
         * @param dragRecyclerView The RecyclerView which scrolled.
     ...
     * a view is recycled.
     *
     * @see DragRecyclerView#setRecyclerListener(RecyclerListener)
     */
    ...
    public static abstract class ViewHolder {
         ...
         * {@link RecycledViewPool}.
         */
        DragRecyclerView mOwnerDragRecyclerView;
         ...
         * positions. All methods in {@link DragRecyclerView.LayoutManager}, {@link DragRecyclerView.State},
         * {@link DragRecyclerView.Recycler} that receive a position expect it to be the layout position
         * of the item.
         * <p>
         * If LayoutManager needs to call an external method that requires the adapter position of
         * the item, it can use {@link #getAdapterPosition()} or
         * {@link DragRecyclerView.Recycler#convertPreLayoutPositionToPostLayout(int)}.
         *
         ...
         * <p>
         * Note that if you've called {@link DragRecyclerView.Adapter#notifyDataSetChanged()}, until the
         * next layout pass, the return value of this method will be {@link #NO_POSITION}.
         *
         * @return The adapter position of the item if it still exists in the adapter.
         * {@link DragRecyclerView#NO_POSITION} if item has been removed from the adapter,
         * {@link DragRecyclerView.Adapter#notifyDataSetChanged()} has been called after the last
         * layout pass or the ViewHolder has already been recycled.
         */
        public final int getAdapterPosition() {
            if (mOwnerDragRecyclerView == null) {
                return NO_POSITION;
            }
            return mOwnerDragRecyclerView.getAdapterPositionFor(this);
        }
         ...
         *
         * @return The the item's id if adapter has stable ids, {@link DragRecyclerView#NO_ID}
         * otherwise
         */
        ...
        public final void setIsRecyclable(boolean recyclable) {
            ...
            if (mIsRecyclableCount < 0) {
                ...
                sLog.e(VIEW_LOG_TAG, "isRecyclable decremented below 0: " +
                        "unmatched pair of setIsRecyable() calls for " + this);
            ...
            if (DEBUG) {
                sLog.d(TAG, "setIsRecyclable val:" + recyclable + ":" + this);
            }
        }
    ...
    private int getAdapterPositionFor(ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags( ViewHolder.FLAG_INVALID |
                ...
                || !viewHolder.isBound()) {
            return DragRecyclerView.NO_POSITION;
        }
     ...
     * {@link DragRecyclerView}. Custom {@link LayoutManager layout managers} are encouraged
    ...
    public static class LayoutParams extends android.view.ViewGroup.MarginLayoutParams {
         ...
         * {@link DragRecyclerView#NO_POSITION} if item represented by this View has been removed or
...
//     * @see LinearSmoothScroller
    ...
    public static abstract class SmoothScroller {
        ...
        private int mTargetPosition = DragRecyclerView.NO_POSITION;
         ...
         * <p>In each animation step, {@link DragRecyclerView} will check
         * for the target view and call either
         * {@link #onTargetFound(android.view.View, DragRecyclerView.State, SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, DragRecyclerView.State, SmoothScroller.Action)} until
         ...
         */
        void start(DragRecyclerView dragRecyclerView, LayoutManager layoutManager) {
            mDragRecyclerView = dragRecyclerView;
            mLayoutManager = layoutManager;
            if (mTargetPosition == DragRecyclerView.NO_POSITION) {
                throw new IllegalArgumentException("Invalid target position");
            }
            mDragRecyclerView.mState.mTargetPosition = mTargetPosition;
            mRunning = true;
            mPendingInitialRun = true;
            mTargetView = findViewByPosition(getTargetPosition());
            onStart();
            mDragRecyclerView.mViewFlinger.postOnAnimation();
        }
         ...
         * {@link #onTargetFound(android.view.View, DragRecyclerView.State, SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, DragRecyclerView.State, SmoothScroller.Action)}.
         */
        final protected void stop() {
            ...
            onStop();
            mDragRecyclerView.mState.mTargetPosition = DragRecyclerView.NO_POSITION;
            mTargetView = null;
            mTargetPosition = DragRecyclerView.NO_POSITION;
         ...
         * {@link DragRecyclerView#NO_POSITION} if no target view is set.
         */
        ...
        private void onAnimation(int dx, int dy) {
            final DragRecyclerView dragRecyclerView = mDragRecyclerView;
            if (!mRunning || mTargetPosition == DragRecyclerView.NO_POSITION || dragRecyclerView == null) {
                stop();
            }
            mPendingInitialRun = false;
            if (mTargetView != null) {
                ...
                if (getChildPosition(mTargetView) == mTargetPosition) {
                    onTargetFound(mTargetView, dragRecyclerView.mState, mRecyclingAction);
                    mRecyclingAction.runIfNecessary(dragRecyclerView);
                    stop();
                } else {
                    sLog.e(TAG, "Passed over target position while smooth scrolling.");
                    mTargetView = null;
                }
            }
            if (mRunning) {
                onSeekTargetStep(dx, dy, dragRecyclerView.mState, mRecyclingAction);
                ...
                if (hadJumpTarget) {
                    ...
                    if (mRunning) {
                        mPendingInitialRun = true;
                        dragRecyclerView.mViewFlinger.postOnAnimation();
                    } else {
                        stop(); // done
                    }
                }
        ...
        /**
         * @see DragRecyclerView#getChildLayoutPosition(android.view.View)
         */
        public int getChildPosition(View view) {
            return mDragRecyclerView.getChildLayoutPosition(view);
        }

        /**
         * @see DragRecyclerView.LayoutManager#getChildCount()
         */
        public int getChildCount() {
            return mDragRecyclerView.mLayout.getChildCount();
        }

        /**
         * @see DragRecyclerView.LayoutManager#findViewByPosition(int)
         */
        public View findViewByPosition(int position) {
            return mDragRecyclerView.mLayout.findViewByPosition(position);
        }

        /**
         * @see DragRecyclerView#scrollToPosition(int)
         * @deprecated Use {@link Action#jumpTo(int)}.
         */
        @Deprecated
        public void instantScrollToPosition(int position) {
            mDragRecyclerView.scrollToPosition(position);
        }
        ...
        protected void onChildAttachedToWindow(View child) {
            if (getChildPosition(child) == getTargetPosition()) {
                mTargetView = child;
                if (DEBUG) {
                    sLog.d(TAG, "smooth scroll target view has been attached");
                }
            }
        }
        ...
        public static class Action {
             ...
             * {@link DragRecyclerView#scrollToPosition(int)}.
             * <p>
            ...
            private void runIfNecessary(DragRecyclerView dragRecyclerView) {
                if (mJumpToPosition >= 0) {
                    final int position = mJumpToPosition;
                    mJumpToPosition = NO_POSITION;
                    dragRecyclerView.jumpToPositionForSmoothScroller(position);
                    changed = false;
                    return;
                }
                if (changed) {
                    ...
                    if (mInterpolator == null) {
                        if (mDuration == UNDEFINED_DURATION) {
                            dragRecyclerView.mViewFlinger.smoothScrollBy(mDx, mDy);
                        } else {
                            dragRecyclerView.mViewFlinger.smoothScrollBy(mDx, mDy, mDuration);
                        }
                    } else {
                        dragRecyclerView.mViewFlinger.smoothScrollBy(mDx, mDy, mDuration, mInterpolator);
                    }
                    consecutiveUpdates ++;
                    if (consecutiveUpdates > 10) {
                        // A new action is being set in every animation step. This looks like a bad
                        // implementation. Inform developer.
                        sLog.e(TAG, "Smooth Scroll action is being updated too frequently. Make sure"
    ...
    public static class State {
         ...
         * {@link DragRecyclerView#NO_POSITION} if there is no target
         * position.
         */
        ...
        public boolean hasTargetScrollPosition() {
            return mTargetPosition != DragRecyclerView.NO_POSITION;
        }
...
//         * @see #animateDisappearance(ViewHolder, ItemHolderInfo)
         ...
         * {@link #recordPreLayoutInformation(DragRecyclerView.State, ViewHolder, int, List)} and
         * {@link #recordPostLayoutInformation(DragRecyclerView.State, ViewHolder)} returns this data
        ...
        public static class ItemHolderInfo {
            ...
            /**
             * The change flags that were passed to
             * {@link #recordPreLayoutInformation(DragRecyclerView.State, ViewHolder, int, List)}.
             */
            @AdapterChanges
             ...
             */
            public ItemHolderInfo setFrom(DragRecyclerView.ViewHolder holder) {
             ...
             *               {@link #recordPreLayoutInformation(DragRecyclerView.State, ViewHolder, int,
             *               List)}.
             * @return This {@link ItemHolderInfo}
             */
            public ItemHolderInfo setFrom(DragRecyclerView.ViewHolder holder,
    ...
    public interface ChildDrawingOrderCallback {
         ...
         *
         * @see DragRecyclerView#setChildDrawingOrderCallback(DragRecyclerView.ChildDrawingOrderCallback)
         */
