...
class ScrollbarHelper {
     ...
     */
    static int computeScrollOffset(DragRecyclerView.State state, OrientationHelper orientation,
                                   View startChild, View endChild, DragRecyclerView.LayoutManager lm,
     ...
     * @param endChild   View closest to end of the list (bottom or right)
     */
    static int computeScrollExtent(DragRecyclerView.State state, OrientationHelper orientation,
                                   View startChild, View endChild, DragRecyclerView.LayoutManager lm,
     ...
     * @param endChild   View closest to end of the list (bottom or right)
     */
    static int computeScrollRange(DragRecyclerView.State state, OrientationHelper orientation,
                                  View startChild, View endChild, DragRecyclerView.LayoutManager lm,
                                  boolean smoothScrollbarEnabled) {
        if (lm.getChildCount() == 0 || state.getItemCount() == 0 || startChild == null ||
                endChild == null) {
