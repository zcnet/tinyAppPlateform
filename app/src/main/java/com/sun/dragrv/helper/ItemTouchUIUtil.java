...
public interface ItemTouchUIUtil {
     ...
     * DragRecyclerView, DragRecyclerView.ViewHolder, float, float, int, boolean)}
     */
    void onDraw(Canvas c, DragRecyclerView recyclerView, View view,
     ...
     * DragRecyclerView, DragRecyclerView.ViewHolder, float, float, int, boolean)}
     */
    void onDrawOver(Canvas c, DragRecyclerView recyclerView, View view,
                    float dX, float dY, int actionState, boolean isCurrentlyActive);

    /**
     * The default implementation for {@link ItemTouchHelper.Callback#clearView(DragRecyclerView,
     * DragRecyclerView.ViewHolder)}
     */
    void clearView(View view);

    /**
     * The default implementation for {@link ItemTouchHelper.Callback#onSelectedChanged(
     * DragRecyclerView.ViewHolder, int)}
     */
