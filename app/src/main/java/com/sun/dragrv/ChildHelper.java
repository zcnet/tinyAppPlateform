 ...
 * <p>
 * It wraps a DragRecyclerView and adds ability to hide some children. There are two sets of methods
 ...
 * <p>
 * When DragRecyclerView needs direct access to the view group children, it can call unfiltered
...
class ChildHelper {
    ...
    void addView(View child, int index, boolean hidden) {
        ...
        if (DEBUG) {
            sLog.d(TAG, "addViewAt " + index + ",h:" + hidden + ", " + this);
        }
    }
    ...
    /**
     * Removes the provided View from underlying DragRecyclerView.
     *
    ...
    void removeView(View view) {
        ...
        if (DEBUG) {
            sLog.d(TAG, "remove View off:" + index + "," + this);
        }
    }

    /**
     * Removes the view at the provided index from DragRecyclerView.
     *
     * @param index Index of the child from the regular perspective (excluding hidden views).
     *              ChildHelper offsets this index to actual ViewGroup index.
     */
    void removeViewAt(int index) {
        ...
        if (DEBUG) {
            sLog.d(TAG, "removeViewAt " + index + ", off:" + offset + ", " + this);
        }
    }
    ...
    void removeAllViewsUnfiltered() {
        ...
        if (DEBUG) {
            sLog.d(TAG, "removeAllViewsUnfiltered");
        }
    }
     ...
     * @param type     View type, can be {@link DragRecyclerView#INVALID_TYPE}.
    ...
    View findHiddenNonRemovedView(int position, int type) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            DragRecyclerView.ViewHolder holder = mCallback.getChildViewHolder(view);
            if (holder.getLayoutPosition() == position && !holder.isInvalid() &&
                    (type == DragRecyclerView.INVALID_TYPE || holder.getItemViewType() == type)) {
                return view;
            }
        }
        return null;
    ...
    void attachViewToParent(View child, int index, ViewGroup.LayoutParams layoutParams,
        ...
        if (DEBUG) {
            sLog.d(TAG, "attach view to parent index:" + index + ",off:" + offset + "," +
                    "h:" + hidden + ", " + this);
        }
    }
    ...
    void detachViewFromParent(int index) {
        ...
        if (DEBUG) {
            sLog.d(TAG, "detach view from parent " + index + ", off:" + offset);
        }
    }
    ...
    void hide(View view) {
        ...
        if (DEBUG) {
            sLog.d(TAG, "hiding child " + view + " at offset " + offset+ ", " + this);
        }
    }
    ...
    static interface Callback {
        ...
        DragRecyclerView.ViewHolder getChildViewHolder(View view);
