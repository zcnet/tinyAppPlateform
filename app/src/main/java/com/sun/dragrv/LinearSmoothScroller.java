...
abstract public class LinearSmoothScroller extends DragRecyclerView.SmoothScroller {
     ...
     * <p>For instance, if the view is virtually on the left of DragRecyclerView, using
     ...
     */
    @Override
    protected void onTargetFound(View targetView, DragRecyclerView.State state, Action action) {
     ...
     */
    @Override
    protected void onSeekTargetStep(int dx, int dy, DragRecyclerView.State state, Action action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
     ...
     * or the right edge of the child with the parent DragRecyclerView.
     *
     ...
     * or the bottom edge of the child with the parent DragRecyclerView.
     *
     * @return SNAP_TO_START, SNAP_TO_END or SNAP_TO_ANY; depending on the current target vector
     * @see #SNAP_TO_START
     * @see #SNAP_TO_END
    ...
    /**
     * When the target scroll position is not a child of the DragRecyclerView, this method calculates
    ...
    protected void updateActionForInterimTarget(Action action) {
        ...
        if (scrollVector == null || (scrollVector.x == 0 && scrollVector.y == 0)) {
            sLog.e(TAG, "To support smooth scrolling, you should override \n"
    ...
    public int calculateDyToMakeVisible(View view, int snapPreference) {
        final DragRecyclerView.LayoutManager layoutManager = getLayoutManager();
        if (!layoutManager.canScrollVertically()) {
            return 0;
        }
        final DragRecyclerView.LayoutParams params = (DragRecyclerView.LayoutParams)
