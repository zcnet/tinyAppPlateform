...
import static com.sun.dragrv.DragRecyclerView.ViewHolder;
import static com.sun.dragrv.DragRecyclerView.ItemAnimator.ItemHolderInfo;

import static com.sun.dragrv.ViewInfoStore.InfoRecord.FLAG_APPEAR_PRE_AND_POST;
import static com.sun.dragrv.ViewInfoStore.InfoRecord.FLAG_APPEAR_AND_DISAPPEAR;
import static com.sun.dragrv.ViewInfoStore.InfoRecord.FLAG_PRE_AND_POST;
import static com.sun.dragrv.ViewInfoStore.InfoRecord.FLAG_DISAPPEARED;
import static com.sun.dragrv.ViewInfoStore.InfoRecord.FLAG_APPEAR;
import static com.sun.dragrv.ViewInfoStore.InfoRecord.FLAG_PRE;
import static com.sun.dragrv.ViewInfoStore.InfoRecord.FLAG_POST;
/**
    ...
    void process(ProcessCallback callback) {
        for (int index = mLayoutHolderMap.size() - 1; index >= 0; index --) {
            ...
            if ((record.flags & FLAG_APPEAR_AND_DISAPPEAR) == FLAG_APPEAR_AND_DISAPPEAR) {
                ...
                // Scrap view.   will handle removing/recycling this.
            } else if (DEBUG) {
